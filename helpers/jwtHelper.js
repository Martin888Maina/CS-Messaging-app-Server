...
module.exports ={
    signAccessToken: (RegisterId)=>{
        return new Promise((resolve, reject)=>{
            ...
            const options = {
                ...
                audience: RegisterId.toString(),//added toString()
            }
    ...
    //The following code is used to verify the signAccessTokens. It is an additional security feature to allow the sytem to detect alterations to the Access tokens
